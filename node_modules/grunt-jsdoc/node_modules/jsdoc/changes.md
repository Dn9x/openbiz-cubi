...
+ Resolved a crash when a JavaScript file contains a [JavaScript 1.8](https://developer.mozilla.org/en-US/docs/Web/JavaScript/add_in_JavaScript/1.8) keyword, such as `let`. (#477)
